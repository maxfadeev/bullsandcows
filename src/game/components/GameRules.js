...
const GameRules = () => (
  <div className="game-rules">
    ...
    <p>It is played with 4 digits. The digits must be all different. Then, in turn, players try to guess their opponent's number who gives the number of matches. If the matching digits are in their right positions, they are "bulls"(green circle here), if in different positions, they are "cows"(orange circle here).</p>
