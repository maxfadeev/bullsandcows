...
const Contact = () => (
  <DocumentTitle title="Contact">
    <div className="contact">
      ...
      <p>Find me on Twitter: <Link to="https://twitter.com/_maxfadeev" target="_blank" rel="noopener">@_maxfadeev</Link></p>
      <p>Find me on Github: <Link to="https://github.com/maxfadeev" target="_blank" rel="noopener">maxfadeev</Link></p>
